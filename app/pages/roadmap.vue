    ...
    <div class="roadmap-wrapper">
      ...
      >
        ...
        <div class="card">
          ...
          <nuxt-img src="/images/roadmap/roadmap-slot.png" alt="line" quality="80" format="webp" class="roadmap-slot" />
        </div>
      </div>
    </div>
  </section>
...
const roadmap = computed(() => [
  ...
  {
    date: "2026+",
    text: "Ecosystem Growth & Governance",
